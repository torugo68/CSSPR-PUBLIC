  ...
  <v-app>
    <v-card class="fill-height">
      <v-layout row fill-height class="fill-height">
        <v-navigation-drawer style="width: 100%; max-width: 250px; min-width: 1%;" class="bg-blue" theme="dark"
          image="/bg-2.jpg" permanent>
          <div style="
            display: flex;
          ...
          <v-list color="transparent">
            <v-list-item prepend-icon="mdi-home" @click="goToHome" title="Início">
            </v-list-item>
          ...
          <template v-slot:append>
            <div class="flex-container">
              <div class="pa-2" style="width:70%;">
                <v-btn append-icon="mdi-logout" block @click="logout">
                  SAIR
                </v-btn>
              </div>
            </div>
